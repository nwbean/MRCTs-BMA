...
source("../R-scripts/full-simulation-function-SA-model-priors.R")
...
a0.surv <- c(-1, 0, 1, -1, 0, 1, -1, 0, 1)  # pre-specified value for prior model probabilities (surv.)
a0.long <- c(-1, -1, -1, 0, 0, 0, 1, 1, 1)  # pre-specified value for prior model probabilities (long.)
