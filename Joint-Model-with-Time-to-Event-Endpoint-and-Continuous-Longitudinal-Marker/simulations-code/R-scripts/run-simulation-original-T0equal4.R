...
input.file <- paste("../cluster-input/input_mat_original_n9340_T0equal4.csv")
...
#reg.te.long <- rep(.073, S)                      # region-specific treatment effects (long. model)
#reg.ints.long <- rep(8.6, S)                     # region-specific intercepts for long. model
