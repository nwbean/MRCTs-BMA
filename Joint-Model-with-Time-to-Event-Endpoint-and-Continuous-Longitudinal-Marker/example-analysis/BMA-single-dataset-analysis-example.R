###############################################################################################
# Execute BMA joint modeling approach for a simulated dataset
#
# Simulated dataset corresponds to the second scenario discussed in Section 4.4 ("Second
# Simulation Study: Unequal Sample Sizes") of the main paper
###############################################################################################


### Set working directory
wd.file <- "example-analysis"    # file path of folder with example code and data
setwd(wd.file)
...
### Read in dataset
surv.dat <- read.csv("example_survival_data.csv", header = TRUE)
long.dat <- read.csv("example_longitudinal_data.csv", header = TRUE)
