...
# beta.star: probability cutoff for global inconsistency for which consider two regions are
...
bma.asymptotic <- function( dat, W.mat, int.cuts, mu0, Sig0, eta0, phi0, mod.mat,
  ...
  for(l in 1:L){
    ...
    # Obtain Pr(|gamma_(l,t) - gamma_(-i)| < -log(epsilon.star)|D,M_l) conditional on M_l,
    # l=1,...,L
