...
plot( epsilon.star, gc.n9340.beta0_2.1, xlab = "", ylab = "", xlim = c(0,max(epsilon.star)),
...
plot( epsilon.star, gc.n9340.1, xlab = "", ylab = "", xlim = c(0,max(epsilon.star)),
      ylim = c(0,1), xaxs = "i", yaxs = "i", yaxt = "n", type = "l", lwd = 3,
      main = "",  col = "midnightblue", cex.axis = 1.2 )
axis( 2, at = c(0, .2, .4, .6, .8, 1), labels = TRUE, las = 1, cex.axis = 1.2 )
...
plot( epsilon.star, gc.n9340.beta0_8.1, xlab = "", ylab = "", xlim = c(0,max(epsilon.star)),
      ylim = c(0,1), xaxs = "i", yaxs = "i", yaxt = "n", type = "l", lwd = 3,
      main = "",  col = "midnightblue", cex.axis = 1.2 )
axis( 2, at = c(0, .2, .4, .6, .8, 1), labels = TRUE, las = 1, cex.axis = 1.2 )
...
# Global consistency plot for beta = 0.5
plot( epsilon.star, gc.n9340.original.1, xlab = "", ylab = "", xlim = c(0,max(epsilon.star)),
      ylim = c(0,1), xaxs = "i", yaxs = "i", yaxt = "n", type = "l", lwd = 3,
      main = "",  col = "midnightblue", cex.axis = 1.2 )
axis( 2, at = c(0, .2, .4, .6, .8, 1), labels = TRUE, las = 1, cex.axis = 1.2 )
title( expression( paste(beta*"*", " = 0.5") ), line = 0.7,
...
legend( "bottomright", c("Same region-specific treatment hazard ratios",
