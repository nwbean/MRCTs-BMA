...
sim.version <- "SA2"   # true control intercept, half of mean difference
num.sims <- 1000
...
cntrl.int <- .082                               # assumed intercept for control group (approximately 20% increase from true value)
