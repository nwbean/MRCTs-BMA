...
input.file <- paste("../cluster-input/input_mat_n7650.csv")
...
#epsilon.star <- c( seq(0, 0.002, by = 0.0005),
#                   seq(0.0025, .035, by = 0.0025),
#                   seq(.04, .07, by = .005) )
#                                   # range of possible MCIDs
beta.star <- .2                     # probability (1 - beta_star) for which consider two regions to be clinically different,
