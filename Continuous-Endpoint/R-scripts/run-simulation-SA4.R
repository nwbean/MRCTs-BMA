...
sim.version <- "SA4"   # half of control intercept, half of mean difference
num.sims <- 1000
...
mean.diff <- .017                               # assumed mean difference (treatment mean minus control mean)
cntrl.int <- .041                               # assumed intercept for control group (approximately 20% increase from true value)
